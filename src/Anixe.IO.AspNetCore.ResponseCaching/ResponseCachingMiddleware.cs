...
namespace Anixe.IO.AspNetCore.ResponseCaching
{
  public class ResponseCachingMiddleware
  {
    ...
    private bool OnFinalizeCacheHeaders(ResponseCachingContext context)
    {
      if (_policyProvider.IsResponseCacheable(context))
      {
        ...
        if (!StringValues.IsNullOrEmpty(varyHeaders) || !StringValues.IsNullOrEmpty(varyQueryKeys))
        {
          ...
          _logger.LogVaryByRulesUpdated(normalizedVaryHeaders.ToString(), normalizedVaryQueryKeys.ToString());
    ...
    internal static void AddResponseCachingFeature(HttpContext context)
    {
      ...
      context.Features.Set<Microsoft.AspNetCore.ResponseCaching.IResponseCachingFeature>(new ResponseCachingFeature());
    }
    ...
    internal static void RemoveResponseCachingFeature(HttpContext context) =>
        context.Features.Set<Microsoft.AspNetCore.ResponseCaching.IResponseCachingFeature>(null);
